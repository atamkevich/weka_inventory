...
public class InventoryVerificator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        predictCsvLoader.setSource(new File("/home/alina/workspace/weka_inventory/src/main/resources/inventory_predicted.csv"));
       ...
       /* predictDataSet.deleteStringAttributes();*/
        ...
        Classifier classifier = (Classifier) SerializationHelper
                .read("/home/alina/workspace/weka_inventory/src/main/resources/inventory.classifier");
